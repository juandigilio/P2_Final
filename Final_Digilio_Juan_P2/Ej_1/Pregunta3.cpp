...
//	ReorderOptions();
//
//	consoleData->PrintText(pack[0].qustion, questionPos);
//
//	consoleData->PrintText(to_string(positions[0]) + "-" + question.correctOption, optionsPos[positions[0]]);
//	consoleData->PrintText(to_string(positions[1]) + "-" + question.option1, optionsPos[positions[1]]);
//	consoleData->PrintText(to_string(positions[2]) + "-" + question.option2, optionsPos[positions[2]]);
//	consoleData->PrintText(to_string(positions[3]) + "-" + question.option3, optionsPos[positions[3]]);
//	consoleData->PrintText(to_string(positions[4]) + "-" + question.option4, optionsPos[positions[4]]);
//
//	correctOption = positions[0];
//}
//
...
//	answerPos.x = (consoleData->GetConsoleCenterV2().x / 2) - (wellDone.length() / 2);
